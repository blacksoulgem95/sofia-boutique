    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <small class="mb-0">{!! __('auth.form.chosen_name') !!}</small>
            </div>
            <div class="mt-3">
                <x-label for="name" :value="__('user.form.surname')" />
            ...
            <!-- Confirm Password -->
            <div class="mt-4">
                <x-label for="password_confirmation" :value="__('user.form.password-confirm')" />
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('login') }}">
                    {{ __('auth.actions.already_registered') }}
                </a>
